    ...
    private float RenderElement(IElement element, float x, float y, float maxX, bool simulate = false)
    {
        ...
        switch (element)
        {
            ...
            default:
                ...
                {
                    var floatObj = element as global::Nedev.DocxToPdf.Converters.FloatingObject;
                    ...
                    return floatObj != null && floatObj.Wrapping == global::Nedev.DocxToPdf.Converters.WrappingStyle.Inline ? y - floatObj.Height : y;
                }
                return y;
        }
    }
