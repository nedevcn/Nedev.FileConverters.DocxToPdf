...
/// <summary>
/// DOCX 样式到 PDF 样式的映射辅助工具
/// </summary>
public static class StyleHelper
{
    /// <summary>
    /// 将 DOCX 颜色（hex 字符串）转为 iTextSharp BaseColor
    /// </summary>
    ...
    /// <summary>
    /// 将 DOCX Twips（1/20 pt）转为 PDF points
    /// </summary>
    ...
    /// <summary>
    /// 将 EMU（English Metric Units）转为 PDF points
    /// </summary>
    ...
    /// <summary>
    /// 将 DXA（1/20 pt）转为 points，用于表格列宽等
    /// </summary>
    ...
    /// <summary>
    /// 将 DOCX half-point 转为 point（字号用）
    /// </summary>
    ...
    /// <summary>
    /// 将 DOCX 边框样式转为 iTextSharp 边框宽度（简化版）
    /// </summary>
